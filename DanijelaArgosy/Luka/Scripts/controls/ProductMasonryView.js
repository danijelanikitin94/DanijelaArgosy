function ProductMasonryView(opts) {
    var that = this;
    $(that).one(that.EVENT_TEMPLATE_LOADED, function (e) {
        ...
        $(that.options.listHref).kendoListView({
            ...
            template: that.TEMPLATE.find("#masonryItem").html(),
    ...
    controlLoader.loadTemplate("ProductMasonryView", function (template) {
...
ProductMasonryView.prototype.EVENT_TEMPLATE_LOADED = "PRODUCT_MASONRY_VIEW_LOADED";
ProductMasonryView.prototype.options = {};
ProductMasonryView.prototype.TEMPLATE = "";

ProductMasonryView.prototype.baseOptions = {
    listHref: "div[data-argosy-view=ProductMasonryView]",
    pagerHref: "div[data-argosy-view=ProductMasonryViewPager]",
    titleHref: "h2[data-argosy-view=ProductMasonryViewTitle]",
    category: "unknown",
    showPricing: true,
    showEstShop: true
};
...
ProductMasonryView.prototype.getDataSource = function () {
    var that = this;
...
ProductMasonryView.prototype.getRandomPrice = function () {
